<header class="navbar navbar-default">
    ...
    <ul class="nav navbar-nav-custom">
        ...
        <!-- Template Options -->
        <!-- Change Options functionality can be found in {{ asset('assets/front-assets/js/app.js')}} - templateOptions() -->
        <li class="dropdown">
    ...
    <ul class="nav navbar-nav-custom pull-right">
        ...
        <li class="dropdown">
            <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">
                <img src="{{ asset('assets/front-assets/img/placeholders/avatars/avatar2.jpg')}}" alt="avatar"> <i class="fa fa-angle-down"></i>
            </a>
            <ul class="dropdown-menu dropdown-custom dropdown-menu-right">
                ...
                <li>
                    ...
                    <!-- <a href="" id="loginId"><i class="fa fa-ban fa-fw pull-right"></i> Logout</a> -->
                    <form action="{{ route ('dashboard.logout') }}" method="POST" >
                         @csrf 
                        <i class="fa fa-ban fa-fw pull-right"></i>  
                        <input class="pl-2" type="submit" value="Logout" >
