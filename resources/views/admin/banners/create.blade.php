    ...
    <div class="col-md-12">
        ...
        <div class="block">
            ...
            <div class="block-title">
                ...
                <h2><strong>New banner</strong> </h2>
            </div>
            ...
            <form action=" {{ route ('dashboard.banners.store') }} " id="reg" onsubmit="process(event)" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
                ...
                <div class="form-group">
                   ...
                   <div class="form-group">
                    <label class="col-md-3 control-label" for="sub_title">Sub Title  {{$key}} <span class="text-danger">*</span></label>
                    <div class="col-md-9">
                        <input type="text" id="{{$key}}[sub_title]" name="{{$key}}[sub_title]" value="{{ old( $lang.'.sub_title') }}" class="form-control">
                        <!-- <span class="help-block">This is a help text</span> -->
