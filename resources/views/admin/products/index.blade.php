...
<div class="content-header">
    <div class="header-section">
        <h1>
            <i class="fa fa-table"></i>Products<br><small></small>
        </h1>
    </div>
</div>
...
<div class="block full">
    ...
    <div class=" f-right">
        <div class="text-right py-2" style="margin-bottom: 7px;">
            ...
            <a class="btn btn-primary " href=" {{ route ('dashboard.products.create') }}">Add New </a>
        ...
        <table id="example-datatable" class="table table-vcenter table-condensed table-bordered">
            <thead>
                <tr>
                    ...
                    <th class="text-center"><i class="gi gi-products"></i>Image</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center"><img src="{{ asset ('/media/products/'. $product -> photo) }}" alt="avatar" width="50" ></td>
                    <td class="text-center">{{ $product -> title }}</td>
                    <td class="text-center">
                        <div class="btn-group">

                            <a href="{{ route('dashboard.products.edit', $product -> id) }}" data-toggle="tooltip" title="Edit" class="btn btn-xs btn-default "><i class="fa fa-pencil"></i></a>
