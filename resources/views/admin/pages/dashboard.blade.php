                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="block full">
                                ...
                                <!-- Web Server Content -->
                                <!-- Flot Charts (initialized in {{ asset('assets/front-assets/js/pages/index2.js')}}), for more examples you can check out http://www.flotcharts.org/ -->
                            ...
                            <!-- Jquery Sparkline (initialized in {{ asset('assets/front-assets/js/pages/index2.js')}}), for more examples you can check out http://omnipotent.net/jquery.sparkline/#s-about -->
                            <div class="block full">
                                        ...
                                        <ul class="timeline-list">
                                                ...
                                                <div class="timeline-content">
                                                    ...
                                                    <div class="row push">
                                                        <div class="col-sm-6 col-md-4">
                                                            <a href="{{ asset('assets/front-assets/img/placeholders/photos/photo1..jpg')}}" data-toggle="lightbox-image">
                                                                <img src="{{ asset('assets/front-assets/img/placeholders/photos/photo1..jpg')}}" alt="image">
                                                            </a>
                                                        </div>
                                                        <div class="col-sm-6 col-md-4">
                                                            <a href="{{ asset('assets/front-assets/img/placeholders/photos/photo22..jpg')}}" data-toggle="lightbox-image">
                                                                <img src="{{ asset('assets/front-assets/img/placeholders/photos/photo22..jpg')}}" alt="image">
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <li class="active">
                                                ...
                                                <div class="timeline-content">
                                                    ...
                                                    <div class="row push">
                                                        <div class="col-sm-6 col-md-4">
                                                            <a href="{{ asset('assets/front-assets/img/placeholders/photos/photo23..jpg')}}" data-toggle="lightbox-image">
                                                                <img src="{{ asset('assets/front-assets/img/placeholders/photos/photo23..jpg')}}" alt="image">
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
